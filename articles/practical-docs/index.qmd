...
Doumont's advice concerns the "who" and the "how" while the [GUT of documentation](https://documentation.divio.com/) provides a useful high level framework for the "what". This framework classifies different types of documentation based on use. For projects which [build analyses as reproducible analytical pipelines](../analysis-as-rap/), understanding-oriented documentation is the first cab off the ranks as it provides value to widest audience. 
