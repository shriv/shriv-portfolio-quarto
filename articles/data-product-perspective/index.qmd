...
I also found that we were all developing analyses as a collection of scripts with some instructions to run them. Even if analysts [build analyses as reproducible analytical pipelines](../analysis-as-rap/index.qmd), analyses often remained a technical obscurity without a useful output tailored for the end users. 
